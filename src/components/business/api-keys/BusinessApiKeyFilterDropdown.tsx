...
interface BusinessApiKeyFilterDropdownProps {
  value: string;
...
export default function BusinessApiKeyFilterDropdown({
  value,
  options,
  onChange,
  ariaLabel,
}: BusinessApiKeyFilterDropdownProps) {
    ...
    >
      ...
      >
        ...
        <CaretDown
          ...
          weight="bold"
          className={[
            "shrink-0 text-[var(--color-foreground-muted)] transition-transform duration-200",
            open ? "rotate-180" : "",
          ].join(" ")}
        />
      </button>
      ...
      {open && (
        <div
          role="listbox"
          className={[
            "absolute left-0 top-[calc(100%+7px)] z-[90]",
            "w-full min-w-[180px]",
            "sm:left-auto sm:right-0 sm:w-[200px]",
