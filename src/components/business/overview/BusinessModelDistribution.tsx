import { businessModelUsage } from "@/lib/business/overview-data";

export default function BusinessModelDistribution() {
  return (
      ...
      <div className="flex items-start justify-between gap-4">
        <div>
          ...
          <p className="mt-2 text-[9px] leading-5 text-[var(--color-foreground-secondary)]">
            Distribution of routed workloads across
