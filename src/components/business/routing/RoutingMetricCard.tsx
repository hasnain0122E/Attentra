...
export default function RoutingMetricCard({
  label,
  value,
  detail,
  change,
  accent = false,
}: RoutingMetricCardProps) {
  return (
    <article
      className={[
    ...
    >
      ...
      <div className="relative z-10">
        ...
        <div className="mt-6 flex items-end justify-between gap-4">
          ...
          {change && (
            <div className="mb-1 rounded-full bg-[var(--color-surface-soft)] px-2.5 py-1 font-mono text-[7px] uppercase tracking-[0.07em] text-[var(--color-foreground-secondary)]">
              {change}
            </div>
          )}
        </div>
